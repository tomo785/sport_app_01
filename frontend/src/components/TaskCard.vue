    ...
    <view class="plan-section">
      ...
      <view class="cards-row-1">
        ...
        <view class="card today-plan-card" @click="onPlanClick">
          <view class="card-icon-wrapper">
            <AppIcon class="card-icon" name="strength" size="16" />
          ...
          <view class="plan-content">
            ...
            <view class="rest-time" v-if="todayTask.restTime">
              <AppIcon class="rest-icon" name="time" size="9" />
        ...
        <view class="card stats-card">
          <view class="stat-item">
            <view class="stat-icon heart"><AppIcon name="cardio" size="12" /></view>
          ...
          <view class="stat-item">
            <view class="stat-icon fire"><AppIcon name="intensity" size="12" /></view>
            <view class="stat-info">
          ...
          <view class="stat-item">
            <view class="stat-icon chart"><AppIcon name="chart" size="12" /></view>
            <view class="stat-info">
          ...
          <view class="stat-item">
            <view class="stat-icon target"><AppIcon name="target" size="12" /></view>
            <view class="stat-info">
      ...
      <view class="cards-row-2">
        ...
        <view class="card device-card" @click="onDeviceClick">
          <view class="device-icon"><AppIcon name="time" size="24" /></view>
        ...
        <view class="card reminder-card">
          <view class="reminder-header">
            <AppIcon class="reminder-icon" name="time" size="12" />

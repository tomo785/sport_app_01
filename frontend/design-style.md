...
| 类型 | 图标 | 主色 | 浅底 | 渐变 |
|---|---|---|---|---|
| 跑步/有氧 | 🏃 | `#22c55e` | `#ecfdf5` / `#f0fdf4` | `#22c55e → #16a34a` |
| 力量 | 💪 | `#3b82f6` | `#eff6ff` | `#3b82f6 → #2563eb` |
| 瑜伽/拉伸 | 🧘 | `#a855f7` / `#0ea5a4` | `#fdf4ff` | — |
| HIIT | 🔥 | `#f97316` | `#fff7ed` | — |
| 休息 | 😴 | `#94a3b8` | `#f1f5f9` | — |
| 骑行 | 🚴 | `#22c55e` | `#d1fae5 → #a7f3d0` | — |
| 健走 | 🚶 | `#3b82f6` | `#dbeafe → #bfdbfe` | — |
...
7. **避免使用 Emoji**：图标优先使用图片资源（`/static/images/`）或 SVG 图标，不使用 Emoji 作为 UI 图标。Emoji 在不同平台渲染不一致，影响视觉统一性。仅在无合适图标资源时作为临时占位使用
